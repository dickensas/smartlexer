...
MemberExpression
  = head:(
    ...
    tail:(
        __ "[" __ "]" __ property:Expression? {
          return { property: property, dtype: "Array", computed: false };
        }
    ...
    )*
    {
      return tail.reduce(function(result, element) {
        return {
          type: (element.dtype === "Generic"?"GenericMemberExpression": (element.dtype === "Array"?"ArrayMemberExpression":"MemberExpression")),
          object: result,
		  dtype: element.dtype,
		  id: element.id,
...
VariableDeclaration
  = id:GenericIdentifier init:(__ Initialiser)? {
      return {
  ...
  /
    id:ArrayIdentifier init:(__ Initialiser)? {
      return {
        type: "VariableDeclarator",
        id: id,
        init: extractOptional(init, 1)
...
GenericIdentifier
  = id:Identifier __ "<" __ type:GenericIdentifier __ ">" __ {
      return {
  ...
  /
    id:Identifier __ "<" __ type:(Identifier __ "," __ Identifier) __ ">" __ {
      return {
        type: "GenericIdentifier",
        kind: id,
		type: type
  ...
  /
    id:Identifier __ "<" __ type:Identifier __ ">" __ {
      return {
        type: "GenericIdentifier",
        kind: id,
		type: type
...
ExpressionStatement
  = !("{" / FunctionToken / Annotation ) expression:Expression EOS {
      return {
